...
export default function SupportPage() {
  return (
    <LegalPage eyebrow="Support" title="Get help from a real person." intro="For account access, organization setup, schedule, chat, or policy questions, contact League Hub support." updated="August 11, 2026">
      <section><h2>Contact support</h2><p>Email <a href="mailto:jonah@leaguehub.ca">jonah@leaguehub.ca</a>. Include your organization name and the email address used for League Hub. We usually respond within one business day.</p></section>
