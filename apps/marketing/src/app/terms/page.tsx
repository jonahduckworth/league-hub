...
export default function TermsPage() {
  return (
    <LegalPage eyebrow="Terms of use" title="Clear expectations for a shared league workspace." intro="These terms govern use of the League Hub mobile app, administration workspace, and related services." updated="August 11, 2026">
      ...
      <section><h2>Contact and governing law</h2><p>Questions can be sent to <a href="mailto:jonah@leaguehub.ca">jonah@leaguehub.ca</a>. These terms are governed by the laws of Alberta and the applicable federal laws of Canada, without limiting consumer rights that cannot legally be waived.</p></section>
    </LegalPage>
  );
}
